...
public class srtParser extends Parser {
	...
	public static class File_Context extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof srtListener ) ((srtListener)listener).enterFile_(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof srtListener ) ((srtListener)listener).exitFile_(this);
		}
	}
	...
	public static class SubtitlesContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof srtListener ) ((srtListener)listener).enterSubtitles(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof srtListener ) ((srtListener)listener).exitSubtitles(this);
		}
	}
	...
	public static class SubtitleContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof srtListener ) ((srtListener)listener).enterSubtitle(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof srtListener ) ((srtListener)listener).exitSubtitle(this);
		}
	}
